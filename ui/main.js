        ...
        this.menu.sections = {
            ...
            'advanced':{'label':'Advanced', 'list':{
                ...
                'redirects':{'label':'Redirects', 
                    'visible':function() { return M.modFlagSet('ciniki.web', 0x04000000);}, 
...
//      this.links.addLeftButton('website', 'Preview', 'M.showWebsite(\'/links\');');
        ...
        this.gallery.sections = {
            'options':{'label':'', 'fields':{
                ...
                'page-gallery-image-quality':{'label':'Image Quality', 
                    'active':function() { return ((M.userPerms&0x01) == 0x01 ? 'yes' : 'no'); },
                    'type':'toggle', 'default':'regular', 'toggles':{'regular':'Regular', 'high':'High'}},
                'page-gallery-image-size':{'label':'Image Size', 
                    'active':function() { return ((M.userPerms&0x01) == 0x01 ? 'yes' : 'no'); },
...
*/
        ...
        this.blog.sections = {
            'options':{'label':'', 'fields':{
                ...
                'page-blog-submenu':{'label':'Submenu', 'type':'toggle', 'default':'yes', 'toggles':{'no':'Off', 'yes':'Default', 'categories':'Categories'}},
                'page-blog-hide-date':{'label':'Hide Published Date', 'type':'toggle', 'default':'no', 'toggles':{'no':'No', 'yes':'Yes'}},
...
//              'page-courses-current-name':{'label':'Name', 'type':'text', 'hint':'Current Courses'},
                ...
                'page-courses-submenu-categories':{'label':'Display Categories Submenu', 'type':'multitoggle', 'default':'no', 'toggles':this.activeToggles},
                'page-courses-list-format':{'label':'Format', 'active':'yes', 'type':'select', 'options':{
                    'clist':'Single Column', 
                    'cilist':'Single Column + Images', 
...
//          'info':{'label':'', 'html':'If you want to allow customers the ability to login and manage their account
            'options':{'label':'', 'fields':{
                ...
                'page-account-callsign-required':{'label':'Callsign Required', 'type':'toggle', 'default':'no', 'toggles':this.activeToggles,

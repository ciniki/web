...
//				}},
	...
	this.showPageFinish = function(cb, page, rsp) {
		if( page == 'about' ) {
			// Decide what is visible based on info module
			if( M.curBusiness.modules['ciniki.info'] != null ) {
				...
				this.about.sections.options.fields['page-about-reviews-active'].active = (flags&0x1000)>0?'yes':'no';
				...
				this.about.sections.options.fields['page-about-reviews-active'].active = 'no';
...
//			}
			...
			this.about.sections._users_display.visible = 'no';

            ...
            . "if(rsp.results!=null&&rsp.results.length>0) {"
                ...
                . "for(i in rsp.results) {"
                    ...
                    . "if(r.primary_image_url!=''){"
                        . "c+=\"<div class='image-list-image'><div class='image-list-wrap image-list-thumbnail'><a href='\"+r.url+\"'><img alt='\"+r.label+' - '+r.title+\"' src='\"+r.primary_image_url+\"'/></a></div></div>\";"
                    . "}else{"
                        . "c+=\"<div class='image-list-image'><div class='image-list-wrap image-list-thumbnail'><a href='\"+r.url+\"'><img alt='\"+r.label+' - '+r.title+\"' src='/ciniki-web-layouts/default/img/noimage_240.png'/></a></div></div>\";"
                    . "}"
                    . "c+=\"<div class='image-list-details'><div class='image-list-title'><h2><a href='\"+r.url+\"' title='\"+r.label+' - '+r.title+\"'>\"+r.label+' - '+r.title+\"</a></h2>\";"
                    . "if(r.subtitle!=''){"

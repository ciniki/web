...
// -------
//
function ciniki_web_processBlockTagImageList($ciniki, $settings, $tnid, $block) {
    ...
    if( !isset($block['base_url']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.web.116', 'msg'=>'Unable to process request'));
    }

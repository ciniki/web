...
//        && isset($settings['site-layout']) && $settings['site-layout'] == 'default'
    ...
    } else if( $settings['site-layout'] != 'private' && $settings['site-layout'] != 'none' && file_exists($ciniki['request']['layout_dir'] . '/default/global.css') ) {
        $content .= "<link rel='stylesheet' type='text/css' media='all' href='" . $ciniki['request']['layout_url'] 
            . "/default/global.css' />\n";
    }
    if( file_exists($ciniki['request']['layout_dir'] . '/' . $settings['site-layout'] . '/layout.css') ) {
        $content .= "<link rel='stylesheet' type='text/css' media='all and (min-width: 33.236em)' href='" . $ciniki['request']['layout_url'] 
            ...
            . "<![endif]-->\n"
            . "";
    } else if( $settings['site-layout'] != 'private' && $settings['site-layout'] != 'none' && file_exists($ciniki['request']['layout_dir'] . '/default/layout.css') ) {
        $content .= "<link rel='stylesheet' type='text/css' media='all and (min-width: 33.236em)' href='" . $ciniki['request']['layout_url'] 
            . "/default/layout.css' />\n"
            . "<!--[if (lt IE 9) & (!IEMobile)]>\n"
    ...
    if( file_exists($ciniki['request']['layout_dir'] . '/' . $settings['site-layout'] . '/ie8.css') ) {
        $content .= "<!--[if IE 8]>\n"
            ...
            . "<![endif]-->\n"
            . "";
    } else if( $settings['site-layout'] != 'private' && $settings['site-layout'] != 'none' && file_exists($ciniki['request']['layout_dir'] . '/default/ie8.css') ) {
        $content .= "<!--[if IE 8]>\n"
            . "<link rel='stylesheet' type='text/css' media='all' href='" . $ciniki['request']['layout_url'] 
            . "/default/ie8.css' />\n"
            . "<![endif]-->\n"
...
//      }
    ...
    if( isset($settings['site-facebook-domain-verification']) 
        && $settings['site-facebook-domain-verification'] != '' 
        ) {
        $content .= '<meta name="facebook-domain-verification" content="' . $settings['site-facebook-domain-verification'] . '"/>' . "\n";
    }
...
//  }
    ...
    //
    // Include google tag (basic not google tag manager)
    //
    if( isset($settings['site-google-gtag-code']) && $settings['site-google-gtag-code'] != '' ) {
        $content .= "<script async src=\"https://www.googletagmanager.com/gtag/js?id={$settings['site-google-gtag-code']}\"></script>"
            . "<script>"
              . "window.dataLayer = window.dataLayer || [];"
                . "function gtag(){dataLayer.push(arguments);}"
                . "gtag('js', new Date());"
                . "gtag('config', '{$settings['site-google-gtag-code']}');"
                . "</script>";
    } 
    //
    // Include google tag manager
    //
    elseif( isset($settings['site-google-gtm-code']) && $settings['site-google-gtm-code'] != '' ) {
...
//          $signin_content .= "<span class='social-icons'>$social_icons</span>";
    ...
    $content .= "<header class='switch-at-80'>\n";
...
/*          } elseif( $page['title'] != '' && $page['permalink'] != '' ) {
    ...
    if( !isset($ciniki['tenant']['modules']['ciniki.web']['flags']) || ($ciniki['tenant']['modules']['ciniki.web']['flags']&0x0200) == 0 ) {
        ...
        if( isset($settings['page-fielddaylog-active']) && $settings['page-fielddaylog-active'] == 'yes' ) {
            if( isset($settings['page-fielddaylog-name']) && $settings['page-fielddaylog-name'] != '' ) {
                $content .= "<li class='menu-item$hide_menu_class" . ($ciniki['request']['page']=='fielddaylog'?' menu-item-selected':'') . "'><a href='" . $ciniki['request']['base_url'] . "/fieldday'>" . $settings['page-fielddaylog-name'] . "</a></li>";
            } else {

...
error_log(print_r($args, true));
    ...
    $rc = ciniki_web_checkAccess($ciniki, $args['tnid'], 'ciniki.web.pageImageAdd'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    } 
    ...
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.web.148', 'msg'=>'Unable to get a new UUID', 'err'=>$rc['err']));
    }
    $args['uuid'] = $rc['uuid'];

    if( $args['page_id'] <= 0 ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.web.149', 'msg'=>'No page specified'));
    }
    ...
    if( $rc['num_rows'] > 0 ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.web.150', 'msg'=>'You already have an image with this name, please choose another name'));
    }
    ...
    return ciniki_core_objectAdd($ciniki, $args['tnid'], 'ciniki.web.page_image', $args, 0x07);
}
?>

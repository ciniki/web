...
//  </users>
//
function ciniki_web_pageImageHistory($ciniki) {
    //
    ...
    $rc = ciniki_web_checkAccess($ciniki, $args['business_id'], 'ciniki.web.pageImageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.web', 'ciniki_web_history', 
        $args['business_id'], 'ciniki_web_page_images', $args['page_image_id'], $args['field']);
}
?>

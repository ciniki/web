...
function ciniki_web_privateThemeContentHistory($ciniki) {
	...
	$rc = ciniki_web_checkAccess($ciniki, $args['business_id'], 'ciniki.web.privateThemeContentHistory');
	if( $rc['stat'] != 'ok' ) {
		return $rc;
	}
	...
	return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.web', 'ciniki_web_history', 
		$args['business_id'], 'ciniki_web_theme_content', $args['content_id'], $args['field']);
}
?>

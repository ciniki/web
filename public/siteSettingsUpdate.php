...
function ciniki_web_siteSettingsUpdate(&$ciniki) {
    ...
    $settings_fields = array(
        ...
        'page-home-ags-slider-type',
        'page-home-ags-slider-size',
        'page-home-ags-slider-labels',
...
//      'page-about-image-caption',
        ...
        'page-artgalleryexhibitions-thumbnail-format',
        'page-artgalleryexhibitions-thumbnail-padding-color',
        'page-artgalleryexhibitions-display-format',
        'page-propertyrentals-active',
        'page-propertyrentals-name',
        'page-propertyrentals-rented',
        'page-fielddaylog-active',
        'page-winterfielddaylog-active',
//        'page-jiji-active',
//        'page-jiji-name',
        'page-blog-active',
        'page-blog-name',
        ...
        'page-writingfestivals-active',
        'page-writingfestivals-title',
        'page-writingfestivals-festivalid',

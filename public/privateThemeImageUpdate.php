...
function ciniki_web_privateThemeImageUpdate(&$ciniki) {
    ...
    $rc = ciniki_web_checkAccess($ciniki, $args['tnid'], 'ciniki.web.privateThemeImageUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.web.theme_image', $args['theme_image_id'], $args);
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

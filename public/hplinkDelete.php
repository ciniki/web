...
function ciniki_web_hplinkDelete(&$ciniki) {
    ...
    $rc = ciniki_web_checkAccess($ciniki, $args['tnid'], 'ciniki.web.hplinkDelete');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectCheckUsed($ciniki, $args['tnid'], 'ciniki.web.hplink', $args['hplink_id']);
    if( $rc['stat'] != 'ok' ) {
    ...
    // Remove the hplink
    //
    $rc = ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.web.hplink',
